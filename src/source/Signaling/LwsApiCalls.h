...
// Timeout values
#define SIGNALING_SERVICE_API_CALL_CONNECTION_TIMEOUT (12 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define SIGNALING_SERVICE_API_CALL_COMPLETION_TIMEOUT (15 * HUNDREDS_OF_NANOS_IN_A_SECOND)
