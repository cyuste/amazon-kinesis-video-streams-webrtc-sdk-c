...
// turn state timeouts
#define DEFAULT_TURN_SOCKET_CONNECT_TIMEOUT    (15 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_GET_CREDENTIAL_TIMEOUT    (15 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_ALLOCATION_TIMEOUT        (15 * HUNDREDS_OF_NANOS_IN_A_SECOND)
